  ...
  def for_issues(user)
    ...
    subject = ['[빠띠 가브크래프트] 이번 주엔 어떤 소식이 올라왔을까요?',
      '[빠띠 가브크래프트] 이 주엔 어떤 일들이 있었는지 확인하세요.',
      '[빠띠 가브크래프트] 어떤 이야기들이 나오고 있을까요?',
      '[빠띠 가브크래프트] 잘지내시나요? 빠띠 가브크래프트 이야기들을 전합니다.',
      '[빠띠 가브크래프트] 이번 주 이야기들이 도착했습니다!'].sample

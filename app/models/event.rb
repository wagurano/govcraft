class Event < ApplicationRecord
  ...
  ['김무성', '부산', '중구영도구', '부산광역시 영도구 태종로 40 2층 202호'],
  ...
  ['엄용수', '경남', '밀양시의령군함안군창녕군',  '경남 밀양시 밀양대로 1856, 3층'],
  ...
  ['이헌승', '부산', '부산진구을', '부산광역시 부산진구 가야대로 607 (가야동50-4) 새마을회관 8층'],
  ...
  ['정유섭', '인천', '부평구갑',  '인천광역시 부평구 주부토로 3 3층'],
  ['정종섭', '대구', '동구갑', '대구광역시 동구 동대구로 523 3층'],
  ...
  ['주호영', '대구', '수성구을',  '대구광역시 수성구 동대구로 6 2층'],
